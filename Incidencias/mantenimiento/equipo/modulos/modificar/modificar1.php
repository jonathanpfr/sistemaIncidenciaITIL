...
//require_once ("../../../../clases/e/class_area.php");
...
<!--        <h4 align="center">TRABAJADORES</h4>-->
        ...
        <div  class='centrar'>
            <div>
                ...
                <h3 align="center"> Actualizar Equipo</h3>
                <?php
            ...
            <div >
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Equipo:  </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="nombre_equipo" placeholder="equipo" value="<?php echo $nombre_equipo; ?>">
                            <input type="hidden" id="id_equipo" value="<?php echo $id_equipo; ?>">
<!--                            <input type="hidden" id="id_trabajador" >-->
                        ...
                        <div class="col-sm-4">
                             <input type="hidden" id="id_are2" value="<?php echo $id_area; ?>">
