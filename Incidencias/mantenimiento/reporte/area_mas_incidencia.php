...
<hr>
        ...
        <form name=" form1" method="get" action="">
            ...
            <h4 align="center">AREA CON MAS INCIDENCIA</h4>
            <hr>
                <div   class='centrar'>
...
//                                $fec_fin = $hoy;
                            ...
                            <br>
                                ...
                                <center><?php echo $cadena; ?></center> <br> <br>
                                        ...
                                        <a class="btn btn-warning" href=" javascript:verpdf('reportes/area.php?fec_ini=<?php echo $fec_ini; ?>&fec_fin=<?php echo $fec_fin; ?>&cadena=<?php echo $cadena; ?>'); " >  
                                            <span class="glyphicon glyphicon-print"></span>Imprimir
                                        </a>
                                        <a class="btn btn-warning" href=" javascript:verpdf('graficos/area.php?fec_ini=<?php echo $fec_ini; ?>&fec_fin=<?php echo $fec_fin; ?>&cadena=<?php echo $cadena; ?>'); " >  
