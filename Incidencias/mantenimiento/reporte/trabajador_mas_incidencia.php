...
<hr>
        ...
        <form name=" form1" method="get" action="">
            ...
            <h4 align="center">TRABAJADOR CON MAS INCIDENCIA</h4>
            <hr>
                <div   class='centrar'>
                            ...
                            <br>
                                ...
                                <center><?php echo $cadena; ?></center> <br> <br>
                                        <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $consulta = $cl->trabajador_mas_incidencia($fec_ini, $fec_fin);
                                        ...
                                        <a class="btn btn-warning" href=" javascript:verpdf('reportes/trabajador.php?fec_ini=<?php echo $fec_ini; ?>&fec_fin=<?php echo $fec_fin; ?>&cadena=<?php echo $cadena; ?>'); " >  
                                            <span class="glyphicon glyphicon-print"></span>Imprimir
                                        </a>
                                        <a class="btn btn-warning" href=" javascript:verpdf('graficos/trabajador.php?fec_ini=<?php echo $fec_ini; ?>&fec_fin=<?php echo $fec_fin; ?>&cadena=<?php echo $cadena; ?>'); " >  
