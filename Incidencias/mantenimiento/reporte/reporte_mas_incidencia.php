...
<hr>
        ...
        <form name=" form1" method="get" action="">
            ...
            <h4 align="center">INCIDENCIA MAS ALTA</h4>
            <hr>
                <div   class='centrar'>
                            ...
                            <br>
                                ...
                                <center><?php echo $cadena; ?></center> <br> <br>
                                        <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $consulta = $cl->incidencia_mas_alta($fec_ini, $fec_fin);
                                        ...
                                        <a class="btn btn-warning" href=" javascript:verpdf('reportes/incidencia.php?fec_ini=<?php echo $fec_ini; ?>&fec_fin=<?php echo $fec_fin; ?>&cadena=<?php echo $cadena; ?>'); " >  
                                            <span class="glyphicon glyphicon-print"></span>Imprimir
                                        </a>
                                        <a class="btn btn-warning" href=" javascript:verpdf('graficos/incidencia.php?fec_ini=<?php echo $fec_ini; ?>&fec_fin=<?php echo $fec_fin; ?>&cadena=<?php echo $cadena; ?>'); " >  
