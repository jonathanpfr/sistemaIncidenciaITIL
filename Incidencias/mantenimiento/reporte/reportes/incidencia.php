...
$pdf->Cell(240, 8, 'INCIDENCIAS MAS ALTAA' . $cadena, 0, 0, 'C'); //al centro
...
$pdf->Cell(75, 10, '', 0, 0);
$pdf->Cell(80, 8, 'INCIDENCIAS', 1, 0, 'C', true);
$pdf->Cell(70, 8, 'NUMEROS', 1, 0, 'C', true);
$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
...
for ($i = 0; $i < sizeof($consulta); $i++) {
    $pdf->setfont('Arial', '', 9);
    $pdf->Cell(75, 10, '', 0, 0);
    $pdf->Cell(80, 10,$consulta[$i]["nom_incidencia"], 1, 0, 'C');
