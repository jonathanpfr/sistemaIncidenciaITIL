$(document).ready(function () {
    ...
    $('#id_botn_consultar').click(function (table) {
        ...
        if (tipo_busqueda == 1) {//dia
            ...
            window.location.href = "reporte_mas_incidencia.php?fec_ini=" + fecha_inicio + "&fec_fin=" + fecha_inicio + "";
        }
        if (tipo_busqueda == 2) {//mes
            var fecha_inicio = $('#fecha_inicio').val();
            var fecha_fin = $('#fecha_fin').val();

            window.location.href = "reporte_mas_incidencia.php?fec_ini=" + fecha_inicio + "&fec_fin=" + fecha_fin + "";
        }
