        ...
        <div   class='centrar'>
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php
                    $vent = new cargo();
                    $consulta = $vent->get_cargo();
                    for ($i = 0; $i < sizeof($consulta); $i++) {
                        $id_tra = $consulta[$i]["id_cargo"];$nombre = $consulta[$i]["nombre_cargo"];
                        echo "<tr>";
                        echo "<td>";
                        echo "<a href='modulos/modificar/modificar1.php?id_cargo=$id_tra&nombre_cargo=$nombre'>Modificar</a>";
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["id_cargo"];
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["nombre_cargo"];
                        echo "</td>";
                        
                        echo "<td>";
                        
                        echo "<a onclick='return confirm(\"Esta Seguro de Eliminar el cargo : $nombre ?\")' href='modulos/eliminar/eliminar.php?id_cargo=$id_tra'>Eliminar</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
