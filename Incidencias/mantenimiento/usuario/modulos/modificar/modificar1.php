            ...
            <div >
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="razon_social" placeholder="nombres y apellidos" value="<?php echo $nombre_usu; ?>">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="telefono" placeholder="telefono" value="<?php echo $telefono; ?>">
                        </div>
                    </div>
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Direccion:  </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="direccion" placeholder="direccion" value="<?php echo $direccion; ?>">
                        </div>
                    </div>
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">usuario:  </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="usuario" placeholder="usuario" value="<?php echo $usuario; ?>">
                        </div>
                    </div>
                        <div class="form-group">
