...
<!--        <h4 align="center">TRABAJADORES</h4>-->
        ...
        <div  class='centrar'>
            ...
            <div >
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="razon_social" placeholder="nombres y apellidos" >
            ...
            <div >
                <center>
                <button type="button" class="btn btn-success" id="btn_registrar"><span class="glyphicon glyphicon-floppy-saved"></span>Registrar Datos</button>
