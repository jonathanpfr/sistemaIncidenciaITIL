        ...
        <div   class='centrar'>
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php
                    $vent = new sucursal();
                    $consulta = $vent->get_sucursal();
                    for ($i = 0; $i < sizeof($consulta); $i++) {
                        $id_tra = $consulta[$i]["id_sucursal"];
                        $nombre = $consulta[$i]["nombre_sucursal"];
                        $ubicacion = $consulta[$i]["ubicacion"];
                        $telefono = $consulta[$i]["telefono"];
                        echo "<tr>";
                        echo "<td>";
                        echo "<a href='modulos/modificar/modificar1.php?id_sucursal=$id_tra&ubicacion=$ubicacion&nombre=$nombre&telefono=$telefono'>Modificar</a>";
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["id_sucursal"];
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["nombre_sucursal"];
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["ubicacion"];
                        echo "</td>";
                        echo "<td>";
                        ...
                        echo "<a onclick='return confirm(\"Esta Seguro de Eliminar el el Sucursal : $nombre ?\")' href='modulos/eliminar/eliminar.php?id_sucursal=$id_tra'>Eliminar</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
