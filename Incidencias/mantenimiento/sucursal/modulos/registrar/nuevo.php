...
<!--        <h4 align="center">TRABAJADORES</h4>-->
        ...
        <div  class='centrar'>
            <div>
                ...
                <h3 align="center"> Registrar Sucursal</h3>
            </div>
            <hr>
            <div >
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="nombre_sucursal" placeholder="Nombre" >
...
<!--                            <input type="hidden" id="id_trabajador" >-->
            ...
            <div >
                <center>
                <button type="button" class="btn btn-success" id="registro_t"><span class="glyphicon glyphicon-floppy-saved"></span>Registrar Datos</button>
