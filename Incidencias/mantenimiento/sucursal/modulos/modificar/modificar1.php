...
<!--        <h4 align="center">TRABAJADORES</h4>-->
        ...
        <div  class='centrar'>
            <div>
                ...
                <h3 align="center"> Actualizar Sucursal</h3>
                <?php
                $nombre=$_GET['nombre'];
            ...
            <div >
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="sucursal" placeholder="sucursal" value="<?php echo $nombre; ?>">
                            <input type="hidden" id="id_sucursal" value="<?php echo $id_sucursal; ?>">
<!--                            <input type="hidden" id="id_trabajador" >-->
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Ubicacion:  </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="ubicacion" placeholder="ubicacion" value="<?php echo $ubicacion; ?>">
