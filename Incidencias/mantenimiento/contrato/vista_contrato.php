...
<html >
    ...
    <body >
        ...
        <hr>
        <h5 align="center">TIPO DE CONTRATOS</h5>
        <hr>
        <div   class='centrar'>
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php
                    $vent = new tipo_contrato();
                    $consulta = $vent->get_tipo_contrato();
                    for ($i = 0; $i < sizeof($consulta); $i++) {
                        $id_tra = $consulta[$i]["id_tipo_contrato"];
                        $nombre = $consulta[$i]["nombre_contrato"];
                        echo "<tr>";
                        echo "<td>";
                        echo "<a href='modulos/modificar/modificar1.php?id_contrato=$id_tra&nombre_contrato=$nombre'>Modificar</a>";
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["id_tipo_contrato"];
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["nombre_contrato"];
                        echo "</td>";

                        echo "<td>";

                        echo "<a onclick='return confirm(\"Esta Seguro de Eliminar el Tipo de contrato : $nombre ?\")' href='modulos/eliminar/eliminar.php?id_contrato=$id_tra'>Eliminar</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
