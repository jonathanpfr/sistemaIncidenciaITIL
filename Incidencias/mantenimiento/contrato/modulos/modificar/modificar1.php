...
<!--        <h4 align="center">TRABAJADORES</h4>-->
        ...
        <div  class='centrar'>
            <div>
                ...
                <h3 align="center"> Actualizar Cargo</h3>
                <?php
                $nombre_contrato=$_GET['nombre_contrato'];
            ...
            <div >
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="nombre_contrato" placeholder="contrato" value="<?php echo $nombre_contrato; ?>">
                            <input type="hidden" id="id_contrato" value="<?php echo $id_contrato; ?>">
