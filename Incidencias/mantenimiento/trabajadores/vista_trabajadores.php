...
<html >
    ...
    <body >
        ...
        <hr>
        <h5 align="center">TRABAJADORES</h5>
        <hr>
        <div   class='centrar'>
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php
                    $vent = new trabajador();
                    $consulta = $vent->get_trabajador();
                    for ($i = 0; $i < sizeof($consulta); $i++) {
                        $id_tra = $consulta[$i]["id_trabajador"];
                        echo "<tr>";
                        echo "<td>";
                        echo "<a href='modulos/modificar/modificar.php?id_tra=$id_tra'>Modificar</a>";
                        echo "</td>";
                        echo "<td>";
                        ...
                        echo "<a onclick='return confirm(\"Esta Seguro de Eliminar al Trabajador : $nombre ?\")' href='modulos/eliminar/eliminar.php?id_tra=$id_tra'>Eliminar</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
