...
<html >
    ...
    <body>
        <?php
                    $vent = new trabajador();
                    $consulta = $vent->seleccion_trabajador($_GET['id_tra']);
...
<!--        <h4 align="center">TRABAJADORES</h4>-->
        ...
        <div  class='centrar'>
            <div>
                ...
                <h3 align="center"> Actualizar Trabajadores</h3>
            </div>
            <hr>
            <div >
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" id="id_usu" value="<?php echo $_SESSION['id_user']; ?>">
                            <input type="hidden" id="id_trabajador" value="<?php echo $_GET['id_tra'];?>">
                        </div>
                         <label for="inputPassword3" class="col-sm-2 control-label">telefono:</label>
                        <div class="col-sm-4">
                            <input type="email" class="form-control" id="telefono" placeholder="Nom. Contacto" value="<?php echo $consulta[$i]["telefono"]; ?>">
                        </div>
            ...
            <div >
                <?php }?>
                <center>
                <button type="button" class="btn btn-success" id="registro_t"><span class="glyphicon glyphicon-floppy-saved"></span>Actualizar Datos</button>
