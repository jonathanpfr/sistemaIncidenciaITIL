...
<html >
    <head>
        ...
        <!--//jquery.dataTables-->
        <!--<link rel="stylesheet" href="../../paquetes/bootstrap/css/jquery.dataTables.css"/>-->
...
/*                background-image: url("../../imagen/rojo.PNG");
                color: #ffffff;
    ...
    <body >
        ...
        <hr>
        <h5 align="center">LISTADOS DE TICKET ATENDIDOS</h5>
        <hr>
            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="cabecera">Fecha de reporte</th>
                        <th class="cabecera">Nombre Ticket</th>
                        <th class="cabecera">Trabajador</th>
                        <th class="cabecera">Area</th>
                        <th class="cabecera">Estado</th>
                        <th class="cabecera">Ver</th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
                ...
                <tbody>
                    <?php
                    $vent = new ticket();
                    $consulta = $vent->get_ticket_seleccion_tecnico_atendidos($_SESSION['id_tecnico']);
...
//***********************************************************
                        ...
                        echo "<td>";
                        echo "<a href='modelo/observar_ticket_atendido.php?id_ticket=$id_ticket'>Ver</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
