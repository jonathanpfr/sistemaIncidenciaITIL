...
<!--        <h4 align="center">TRABAJADORES</h4>-->
        ...
        <div  class='centrar'>
            <div>
                ...
                <h3 align="center"> Registrar Tecnico</h3>
            </div>
            <hr>
            <div >
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="email" class="form-control" id="telefono" placeholder="Num. telefono" >
                        </div>
            ...
            <div >
                ...
                <center>
                <button type="button" class="btn btn-success" id="registrar_t"><span class="glyphicon glyphicon-floppy-saved"></span>Actualizar Datos</button>
