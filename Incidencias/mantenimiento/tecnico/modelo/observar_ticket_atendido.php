    ...
    <body style="background:url('../../../../imagen/qw.png')no-repeat center center; ">
        ...
        <div  class='centrar'>
            <div>
                ...
                <h3 align="center"> Ticket Atendido</h3>
            </div>
            <hr>
            <div >
            ...
            <div >
                <center>
                    ...
                    <?php
//                                    require_once '../vista_tecnico_ticket_atendidos.php';
                    ?>
                    <button type="button" class="btn btn-success"  onclick=" location.href='../vista_tecnico_ticket_atendidos.php' " ><span class="glyphicon glyphicon-floppy-saved"></span>Volver</button>
                    <button type="button" data-dismiss="modal" class="btn btn-warning" onclick=" location.href='../vista_tecnico_ticket_atendidos.php' "><span class="glyphicon glyphicon-remove"></span>Cancelar</button>
                    <!--</form>-->
                </center>
            </div>
