...
<html >
    <head>
        ...
        <script src="terminar_ticket.js" ></script>
    ...
    <body style="background:url('../../../../imagen/qw.png')no-repeat center center; ">
        ...
        <div  class='centrar'>
            <div>
                ...
                <h3 align="center"> Terminar Ticket</h3>
            </div>
            <hr>
            <div >
            ...
            <div >
                <center>
                    <button type="button" class="btn btn-success" id="terminar"><span class="glyphicon glyphicon-floppy-saved"></span>Terminar</button>
