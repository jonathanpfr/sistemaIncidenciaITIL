...
<html >
    ...
    <body >
        ...
        <hr>
        <h5 align="center">LISTADOS DE TICKET EN ESPERA</h5>
        ...
        <div   class='centrar'>
            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php
                    $vent = new ticket();
                    $consulta = $vent->get_ticket_seleccion_tecnico_espera($_SESSION['id_tecnico']);
...
//***********************************************************
                        ...
                        echo "<td>";
                        echo "<a href='modelo/atender_ticket.php?id_ticket=$id_ticket'>Atender</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
