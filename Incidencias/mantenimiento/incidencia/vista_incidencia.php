...
<html >
    ...
    <body >
        ...
        <hr>
        <h5 align="center">INCIDENCIAS</h5>
        <hr>
        <div   class='centrar'>
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php
                    $vent = new incidencia();
                    $consulta = $vent->get_incidencia();
                    for ($i = 0; $i < sizeof($consulta); $i++) {
                        $id_tra = $consulta[$i]["id_incidencia"];
                         $nombre = $consulta[$i]["nom_incidencia"];
                        echo "<tr>";
                        echo "<td>";
                        echo "<a href='modulos/modificar/modificar1.php?id_incidencia=$id_tra&nombre_incidencia=$nombre'>Modificar</a>";
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["id_incidencia"];
                        echo "</td>";
                        echo "<td>";
                        ...
                        echo "<a onclick='return confirm(\"Esta Seguro de Eliminar la Incidencia : $nombre ?\")' href='modulos/eliminar/eliminar.php?id_incidencia=$id_tra'>Eliminar</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
