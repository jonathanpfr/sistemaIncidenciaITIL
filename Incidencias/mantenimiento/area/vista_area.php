            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    for ($i = 0; $i < sizeof($consulta); $i++) {
                        ...
                        echo "<tr>";
                        echo "<td>";
                        echo "<a href='modulos/modificar/modificar1.php?id_area=$id_tra&nombre_area=$nombre'>Modificar</a>";
                        echo "</td>";
                        echo "<td>";
                        echo $consulta[$i]["id_area"];
                        echo "</td>";
                        echo "<td>";
                        ...
                        echo "<a onclick='return confirm(\"Esta Seguro de Eliminar al area : $nombre ?\")' href='modulos/eliminar/eliminar.php?id_area=$id_tra'>Eliminar</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
